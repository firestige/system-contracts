...
The current first frozen release is Observation Contract/Profile `1.0.0`. It preserves the closed semantics reviewed as candidate `0.3.0`; the version change is the lifecycle-required first frozen-version boundary, not a semantic extension.
