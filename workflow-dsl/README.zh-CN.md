...
本目录是 **Workflow Contract 的 DSL 面**的规范机器表示（`agentops.workflow-dsl@0.1.0`，REVIEW_CANDIDATE）。语义规范文档位于 super project 的 [`docs/contracts/workflow/workflow-definition-dsl.md`](../../docs/contracts/workflow/workflow-definition-dsl.md)（中文翻译：[`workflow-definition-dsl.zh-CN.md`](../../docs/contracts/workflow/workflow-definition-dsl.zh-CN.md)）。
